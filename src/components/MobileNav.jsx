...
function MobileNav({
  ...
  // Se não está na view de chat, mostra apenas a barra de navegação inferior
  if (currentView !== 'chat') {
    return (
  ...
  return (
    <>
      {/* Tela principal mobile - Lista de Conversas */}
      <div className="mobile-main-screen">
        ...
        <div className="mobile-conversations-list">
          {loading ? (
            <div className="mobile-loading">Carregando conversas...</div>
            ...
            <div className="mobile-empty-state">
              ...
              <small>As conversas aparecerão aqui</small>
            </div>
          ) : (
            conversations.map((conv) => (
              ...
              >
                <div className="mobile-conv-avatar">
                  {getInitials(conv.userName)}
                </div>
                <div className="mobile-conv-info">
                  <div className="mobile-conv-header">
                    <span className="mobile-conv-name">{conv.userName}</span>
                    <span className="mobile-conv-time">{formatTime(conv.lastTimestamp)}</span>
                  </div>
                  <div className="mobile-conv-preview">
                    <span className="mobile-conv-message">{conv.lastMessage}</span>
                    {conv.unread > 0 && (
                      <span className="mobile-conv-unread">{conv.unread}</span>
                    )}
                  </div>
                </div>
              </div>
